...
TEST(units, independent_values) {
    ...
    EXPECT_EQ((unsigned)4, new_units.scaleSpace);
    EXPECT_EQ((unsigned)5, new_units.scaleTime);
...
TEST(units, lower_bound) {
    ...
    EXPECT_EQ((unsigned)0, new_units.scaleSpace);
    EXPECT_EQ((unsigned)0, new_units.scaleTime);
...
TEST(units, upper_bound) {
    ...
    EXPECT_EQ((unsigned)15, new_units.scaleSpace);
    EXPECT_EQ((unsigned)15, new_units.scaleTime);
