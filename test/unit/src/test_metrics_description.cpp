...
TEST(metrics_description, insert_child_functor_1) {
    ...
    EXPECT_EQ(4u, desc.at(456).at(1).units.scaleSpace);
    EXPECT_EQ(5u, desc.at(456).at(1).units.scaleTime);
    ...
    EXPECT_EQ(10u, desc.at(456).at(2).units.scaleSpace);
    EXPECT_EQ(11u, desc.at(456).at(2).units.scaleTime);
